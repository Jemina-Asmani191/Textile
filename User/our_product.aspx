<%@ Page Title="" Language="C#" MasterPageFile="~/User/men.master" AutoEventWireup="true" CodeFile="our_product.aspx.cs" Inherits="User_Default" %>
...
<div class="men-wear">
    ...
    <div class="col-md-8 products-right" >
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:constr %>" 
                SelectCommand="SELECT TOP 4 * FROM [product] ORDER BY [category]">
