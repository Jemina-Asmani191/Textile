...
public partial class User_Default : System.Web.UI.Page
{
    ...
    protected void img_btn_ptm_Click(object sender, ImageClickEventArgs e)
    {

        CALLBACK_URL = "http://localhost:7327/Textile/User/invoice.aspx";
        paytmpayment(Session["email"].ToString(), Session["umobileno"].ToString(), Session["uname"].ToString(), Session["orderid"].ToString(), Session["net"].ToString());
    }
}