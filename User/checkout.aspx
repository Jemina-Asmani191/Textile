        ...
        <!--1. LOGIN-->
         ...
         <div class="well">
            ...
            <br />
             ...
             <div class="contact-form2">
				...
				<br />
                 <asp:RegularExpressionValidator ID="rev_uname" runat="server" 
                        ErrorMessage="Only character is valid for User Name.." 
                        ControlToValidate="txt_uname" ValidationExpression="^[A-Z a-z'.\s]{1,30}" SetFocusOnError="true" ForeColor="red"></asp:RegularExpressionValidator>
                <br />
                    <!-- pincode -->
                ...
                <asp:RegularExpressionValidator ID="rev_pin" runat="server" ValidationExpression="^([3]{1})([0-9]{5})$" ErrorMessage="Pincode Is Invalid" ForeColor="Red" SetFocusOnError="True" ControlToValidate="txt_pincode"></asp:RegularExpressionValidator>
                 <asp:RegularExpressionValidator ID="rev_loc" runat="server" ErrorMessage="Only character is valid for Locality.." ValidationExpression="^[a-z A-Z'.\s]{1,30}" ControlToValidate="txt_locality" SetFocusOnError="true" ForeColor="red" style="margin-left:430px;"></asp:RegularExpressionValidator>
                <br />
                   <!-- address -->
                 ...
                 <asp:RegularExpressionValidator ID="rev_add" runat="server" ErrorMessage="Only character is valid for Address.." ValidationExpression="^{1,9}\d[A-Z a-z'-.,/$&#@\s]{1,200}" ControlToValidate="txt_add" SetFocusOnError="true" ForeColor="red"></asp:RegularExpressionValidator><br />             
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;             
             ...
             &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                ...
                <br />
                    ...
                    <asp:TextBox ID="txt_altumobileno" runat="server" 
                        placeholder="Alternate Mobile No" ForeColor="Black" BackColor="White" 
                        required="" MaxLength="10"></asp:TextBox>
				<br />
                 <asp:RegularExpressionValidator ID="rev_landmark" runat="server" ErrorMessage="Only character is valid for Landmark.." ValidationExpression="^{1,9}\d[a-z A-Z'.,\s]{1,150}" ControlToValidate="txt_landmark" SetFocusOnError="true" ForeColor="red"></asp:RegularExpressionValidator>
                <br />
                <!-- DELIVERY ADDRESS -->
            ...
            <td style="width: 708px">
               ...
               <br />
                 ...
                 <br />
                    ...
                    ForeColor="#FF9933" ontextchanged="txt_email_TextChanged" 
                     AutoPostBack="True" Font-Size="Medium" Width="300px" ></asp:TextBox>
         ...
         <div class="well">
           ...
           <asp:Panel ID="pnl_rd_pay" runat="server" Visible="False">
             ...
             <asp:ImageButton ID="img_btn_ptm" runat="server"  
                 ImageUrl="~/User/images/pay.jpg" Height="40px" Width="156px" 
                 onclick="img_btn_ptm_Click"/>
         </div>
         <!--4. // PAYMENT-->
