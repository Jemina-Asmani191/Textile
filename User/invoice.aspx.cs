...
public partial class User_Default : System.Web.UI.Page
{
       ...
       cmd = new SqlCommand(q, cn);
        ...
        if (dr1.HasRows)
        {
            while (dr1.Read())
            {
                ...
                Session["order_date"] = date1.ToString();
                SendPDFEmail(dt);
    ...
    private void SendPDFEmail(DataTable dt)
    {
        using (StringWriter sw = new StringWriter())
        {
            ...
            {
                string companyName = "TextileIndustry";
                string shiping_add = "sector 9,ved road,surat-395009,gujrat.";
                //string imagepath = Server.MapPath("~/User/images/logo.jpg");
                ...
                //sb.Append("<tr><td align='left'>&nbsp; style='height:50px width:50px'" );
                //sb.Append("</td></tr> ");
               ...
               //<img src='../logo/logo3.JPG' height='85' width='75' />
                ...
                sb.Append("<br>" + Sendername + "<br>" + receiveraddress + "<br>" + smobile_no + "<br>" + email);
                ...
                using (MemoryStream memoryStream = new MemoryStream())
                {
                    ...
                    string mailid = email;
                    mail.To.Add(mailid);
                    mail.From = new MailAddress("textileindustry12@gmail.com");
                    ...
                    smtp.Credentials = new System.Net.NetworkCredential("textileindustry12@gmail.com", "textile@2312");
                    smtp.Port = 587;  //465
                    smtp.EnableSsl = true;
                    smtp.Send(mail);
    ...
    {
        //cn.Open();
        //q = "insert into in_contact values('" + txtname.Text + "','" + txtemail.Text + "','" + txtmsg.Text + "')";
        //cmd = new SqlCommand(q, cn);
        //cmd.ExecuteNonQuery();
        //cn.Close();
