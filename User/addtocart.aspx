        ...
        <div class="checkout-left">	
                ...
                <br /><br />
                  <asp:LinkButton ID="lnkbtn_lbl" runat="server" style="margin-left:225px;" 
                    onclick="lnkbtn_lbl_Click" Font-Bold="True" Font-Italic="True" 
                    Font-Size="X-Large">Get Your Discount Is Here...</asp:LinkButton>
                   <br /><br /><br />
                    ...
                    <table class="" style="margin-left:30%;width:41%;">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;
                                ...
                                &nbsp;<asp:Label ID="lbl_per" runat="server" Text="%" Visible="False"></asp:Label>&nbsp;</td>
                            <td>
                                &nbsp;</td>
