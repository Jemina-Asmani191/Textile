...
public partial class User_forgotpassword : System.Web.UI.Page
{
    ...
    private void sendpassword(String mobileno, String password1, String username)
    {
        ...
        string message = "Hi " + username + " , Your Password is " + password1 + " .(textile industry)";
            ...
            byte[] response = wb.UploadValues("https://api.textlocal.in/send/", new NameValueCollection()
                {
                  ...
                  //{"apikey" , "QuOzoxYRyME-FPrDyHR1ldJn3s8DS7J2n9mQlzfOXG"},
               {"apikey" , "vUevv+/CNjc-DfB2ooh2fMbmb2LdfoMy2KXEjDTDbE"},
               // {"apikey" , "WXPdNkak4UA-wgM8ogeY1lWcGyMwW5ZRIFqnzOizUt"},
                //{"apikey" , "WXPdNkak4UA-U3Y3Dn5xXt6pwNVOywYGZkYcu7crl9"},
                {"numbers" , mobileno},
                {"message" , message1},
                {"sender" , "TXTLCL"}
                });
