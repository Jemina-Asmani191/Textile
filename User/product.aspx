<%@ Page Title="" Language="C#" MasterPageFile="~/User/men.master" AutoEventWireup="true" CodeFile="product.aspx.cs" Inherits="User_Default" %>
			...
			<div class="sort-grid">
				...
				<div class="sorting">
                    ...
                    <asp:DropDownList ID="ddl_show" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddl_show_SelectedIndexChanged">
