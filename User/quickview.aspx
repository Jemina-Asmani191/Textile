            ...
            <div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<%--<ul class="slides">--%>
                            ...
                            <div class="thumb-image"> <img src='../Admin/upload/<%#Eval("proimg") %>' data-imagezoom="true" class="img-responsive" style="height: 450px; width: 430px"> </div>
                ...
                <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active bootstrap-tab-text" id="home" aria-labelledby="home-tab">
                            ...
                            <div>
                                        ...
                                        <table class="style1">
                                            <tr style="border: thin dotted #996633">
                                                <td class="style8">
                                                    <br />
                                                    Use Code<br />
                                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("c_code") %>' ForeColor="#FF9933" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                                </td>
                                                <td class="style3" style="border-right-style: groove"></td>
                                                <td>Flat
                                ...
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:constr %>"
                                    SelectCommand="SELECT * FROM [coupon]"></asp:SqlDataSource>
                    ...
                    <asp:Panel ID="Panel2" runat="server" Visible="False">
                        ...
                        <br />
                            ...
                            <asp:TextBox ID="txtname" runat="server" placeholder="Name" Width="100%"></asp:TextBox><br /> <br />
                            <asp:TextBox ID="txtemail" runat="server" placeholder="Email Id" Width="100%"></asp:TextBox><br />
                            <asp:TextBox ID="txtmsg" runat="server" TextMode="MultiLine" 
                                placeholder="Message" Width="100%"></asp:TextBox><br /><br />
                            <asp:Button ID="btn_send" runat="server" Text="SEND" type="submit"
                                OnClick="btn_send_Click" /><br />
                        </div>

                    </asp:Panel>

                    <asp:Panel ID="pnl_rating" runat="server" Visible="False">
                        <div role="tabpanel" class="tab-pane fade in active bootstrap-tab-text" id="Div1" aria-labelledby="home-tab">
                            <h5>User Review</h5>
                            <div>
                                <asp:DataList ID="DataList1" runat="server" DataKeyField="rid"
                                    ...
                                    <ItemTemplate>
                                        <table class="style1">
                                            <tr>
                                                <td class="style7">
                                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("proname") %>'></asp:Label>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </td>
                                                <td class="style6">&nbsp;&nbsp;
                                                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("rmsg") %>'></asp:Label>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </td>
                                                <td>
                                                    <asp:Rating ID="rtng" runat="server" CurrentRating='<%#Eval("rate") %>' StarCssClass="starempty" FilledStarCssClass="starfilled" WaitingStarCssClass="starwaiting"
                                ...
                                <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:constr %>"
                                    SelectCommand="SELECT * FROM [rating]"></asp:SqlDataSource>
                            </div>
                        </div>
                    </asp:Panel>
